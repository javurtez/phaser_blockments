export default class LayerManager {
    ...
    addLayer(layerName: string, setAsDefault = false) {
    ...
    setLayerDepth(layerName: string, depth: number, willSortLayers = true) {
    ...
    setMainLayer(layerName: string) {
        this.defaultLayer = layerName;
    }
    addObject(object: Phaser.GameObjects.GameObject, layerName: string) {
    ...
    moveObjectToLayer(object: Phaser.GameObjects.GameObject, oldLayerName: string, newLayerName: string) {
